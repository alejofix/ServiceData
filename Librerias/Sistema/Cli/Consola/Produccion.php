<?php
	...
	class Produccion extends Command {
		...
		/**
		 * Produccion::existenciaControlador()
		 * 
		...
		/**
		 * Produccion::existenciaClaseControlador()
		 * 
		...
		/**
		 * Produccion::existenciaClaseMetodo()
		 * 
