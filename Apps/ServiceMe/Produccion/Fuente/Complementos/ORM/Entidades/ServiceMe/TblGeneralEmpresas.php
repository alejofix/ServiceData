 ...
 * TblGeneralEmpresas
 *
 * @Table(name="tbl_general_empresas", uniqueConstraints={@UniqueConstraint(name="NOMBRE", columns={"NOMBRE"})}, indexes={@Index(name="IDX_BA077D0DD6A52665", columns={"ESTADO"})})
 * @Entity
 */
class TblGeneralEmpresas
{
    /**
     * @var integer
     *
