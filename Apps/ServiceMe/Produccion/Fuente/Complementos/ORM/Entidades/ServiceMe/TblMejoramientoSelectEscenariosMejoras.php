...
/**
 * TblMejoramientoSelectEscenariosMejoras
 *
 * @Table(name="tbl_mejoramiento_select_escenarios_mejoras", indexes={@Index(name="IDX_42ABC64D6A52665", columns={"ESTADO"})})
 * @Entity
 */
class TblMejoramientoSelectEscenariosMejoras
{
    /**
     * @var integer
     *
     ...
     * @param string $nombre
     *
     * @return TblMejoramientoSelectEscenariosMejoras
     */
