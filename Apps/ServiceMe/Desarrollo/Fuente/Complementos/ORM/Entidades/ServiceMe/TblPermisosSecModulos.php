...
/**
 * TblPermisosSecModulos
 *
 * @Table(name="tbl_permisos_sec_modulos", uniqueConstraints={@UniqueConstraint(name="NOMBRE", columns={"NOMBRE"})}, indexes={@Index(name="IDX_DAEA3E9CD6A52665", columns={"ESTADO"})})
 * @Entity
 */
class TblPermisosSecModulos
{
    /**
     * @var integer
     *
